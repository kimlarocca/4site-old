...
<div class="twd_container">
  <div class="twd_row">
    <div class="twd_column twd_two twd_margin20">
      ...
      <p><em><?php echo $row_category['categoryName']; ?></em></p>
      <p style="color:red">Caution: this action cannot be undone!</p>
      <p><a href="products-categories-delete2.php?productCategoryID=<?php echo $row_category['productCategoryID']; ?>" class="button">delete this category</a></p>
    </div>
  </div>
</div>
</body>
