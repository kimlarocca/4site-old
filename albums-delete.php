...
<div class="twd_container">
  <div class="twd_row">
    <div class="twd_column twd_two twd_margin20">
      <h2>Photo Albums</h2>
      <h3>Delete this photo album</h3>
      <p><?php echo $row_album['albumName']; ?></p>
      <p><span class="red">Caution: this action cannot be undone!!</span></p>
      <form id="form1" name="form1" method="post" action="albums-delete2.php">
        <input type="submit" name="button" id="button" value="Delete Album" />
        <input name="albumID" type="hidden" id="albumID" value="<?php echo $row_album['albumID']; ?>" />
      </form>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
