...
$modules = mysqli_query($cms, $query_modules) or die(mysqli_error($cms));
...
if ($church && $row_modules['moduleName'] == 'Listings and Rentals') header('Location: listings-church.php');
if ($row_modules['moduleName'] == 'Listings and Rentals') header('Location: listings.php');
if ($row_modules['moduleName'] == 'Photo Albums') header('Location: albums.php');
if ($row_modules['moduleName'] == 'Product Catalog') header('Location: products.php');
if ($row_modules['moduleName'] == 'Events') header('Location: events.php');
?>
