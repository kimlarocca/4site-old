...
$photo = mysql_query($query_photo, $cms) or die(mysql_error());
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table border="0" cellpadding="3" cellspacing="0">
    <tr valign="baseline">
      ...
      <td><input type="text" name="photoTitle" value="<?php echo htmlentities($row_photo['photoTitle'], ENT_COMPAT, 'UTF-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right" valign="top">Photo Description:</td>
      <td><textarea name="photoDescription" cols="50" rows="5"><?php echo htmlentities($row_photo['photoDescription'], ENT_COMPAT, 'UTF-8'); ?></textarea></td>
    </tr>
    <tr valign="baseline">
