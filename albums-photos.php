...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table border="0" cellpadding="3" cellspacing="0">
          <tr valign="baseline">
            ...
            <td><input type="text" name="albumName" value="<?php echo htmlentities($row_album['albumName'], ENT_COMPAT, 'UTF-8'); ?>" size="32" /></td>
            <td><input type="submit" value="Save Changes" /><input name="albumID" type="hidden" value="<?php echo $_GET['albumID']; ?>" /></td>
          </tr>
        </table>
      ...
      <div class="pinGridWrapper"><div id="photos" class="pinGrid">
              ...
              <div class="pin"><a href="photos-modify.php?albumID=<?php echo $row_album['albumID']; ?>&photoID=<?php echo $row_photos['id']; ?>"><img src="uploads/thumb-<?php echo $row_photos['file_name']; ?>"/></a><h2><?php echo $row_photos['photoTitle']; ?></h2><p><?php echo $row_photos['photoDescription']; ?></p><div style="margin:auto; width:100px; padding:10px 0 10px 0"><a href="albums-photos.php?action=cover&albumID=<?php echo $row_album['albumID']; ?>&photoID=<?php echo $row_photos['id']; ?>" class="tooltip" title="set album cover"><img style="width:22px" src="images/<?php echo $row_photos['coverPhoto']; ?>.png" width="32" height="32" /></a> <a href="photos-modify.php?albumID=<?php echo $row_album['albumID']; ?>&photoID=<?php echo $row_photos['id']; ?>" class="tooltip" title="update photo"><img style="width:22px" src="images/edit.png" width="32" height="32" /></a> <a href="photos-delete.php?albumID=<?php echo $row_album['albumID']; ?>&photoID=<?php echo $row_photos['id']; ?>" class="tooltip" title="delete photo"><img style="width:22px" src="images/delete.png" width="32" height="32" /></a></div></div>
