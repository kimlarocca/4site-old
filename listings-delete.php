...
<div class="twd_container">
  <div class="twd_row">
    <div class="twd_column twd_two twd_margin20">
      ...
      <p><?php echo $row_listing['propertyLocation']; ?></p>
      <p><span class="red">Caution: this action cannot be undone!!</span></p>
      <form id="form1" name="form1" method="post" action="listings-delete2.php">
        <input type="submit" name="button" id="button" value="Delete Listing" />
        <input name="listingID" type="hidden" id="listingID" value="<?php echo $row_listing['listingID']; ?>" />
      </form>
