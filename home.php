...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    $insertSQL = sprintf("INSERT INTO cmsPages (websiteID, username, pageTitle, pageActive, pageContent) VALUES (%s, %s, %s, %s, '')",
...
$cmsModules = mysqli_query($cms, $query_cmsModules) or die(mysqli_error($cms));
...
<div class="twd_container">
    <div class="twd_row">
        <div class="twd_column twd_two twd_margin20">
                        ...
                        <tr valign="baseline">
                            <td>Page Title:
                                <input type="hidden" name="websiteID"
                                       value="<?php echo $row_currentUser['websiteID']; ?>"/>
                                <input type="hidden" name="username"
                                       value="<?php echo $row_currentUser['username']; ?>"/>
            ...
            <?php
            if ($totalRows_content < 1)
            echo '<p>You do not have any content pages.</p>';
            else {
            ?>
            <table border="0" cellpadding="5" cellspacing="0">
                ...
                do { ?>
                    <tr>
                        ...
                        <td>
                            <a href="content-modify.php?pageID=<?php echo $row_content['pageID']; ?>"><?php echo $row_content['pageTitle']; ?></a>
                        </td>
                        <td width="125"><a class="tooltip" title="publish this page"
                                           href="content-publish.php?pageID=<?php echo $row_content['pageID']; ?>"><img
                                        src="images/upload.png" width="22" height="22"/></a> <a class="tooltip"
                                                                                                target="_blank"
                                                                                                title="preview this page"
                                                                                                href="<?php echo $row_currentUser['url']; ?>/preview.php?pageID=<?php echo $row_content['pageID']; ?>"><img
                                        src="images/view.png" width="22" height="22"/></a> <a class="tooltip"
                                                                                              title="edit this page"
                                                                                              href="content-modify.php?pageID=<?php echo $row_content['pageID']; ?>"><img
                                        src="images/edit.png" width="22" height="22"/></a> <a class="tooltip"
                                                                                              title="delete this page"
                                                                                              href="content-delete.php?pageID=<?php echo $row_content['pageID']; ?>"><img
                                        src="images/delete.png" width="22" height="22"/></a></td>
                    </tr>
        ...
        <div class="twd_column twd_two twd_margin20">
            ...
            if ($church == false) {
                if ($totalRows_cmsModules < 1) echo '<p>You do not have any website modules.</p>';
                    ...
                    do { ?>
                        <p><a class="button"
                              href="modules-manage.php?moduleID=<?php echo $row_cmsModules['moduleID']; ?>"><?php echo $row_cmsModules['moduleName']; ?></a>
                        </p>
