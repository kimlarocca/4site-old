...
$listings = mysqli_query($cms, $query_listings) or die(mysqli_error($cms));
...
<div class="twd_container">
  <div class="twd_row">
    <div class="twd_column twd_two twd_margin20">
      <h2>Listings &amp; Rentals Module</h2>
      <p><a href="listings-add.php" class="button">add a new listing</a></p>
<h3>manage your listings</h3>
<?php
//check url parameters
if ($_GET['action'] == 'deleted') print '<p style="color:red;">Your listing has been deleted.</p>';
?>
<table border="0" cellpadding="5" cellspacing="0">
        <tr>
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><a href="?sortBy=mlsNumber"><strong>MLS#</strong></a></td>
          <td><u><strong><a href="?sortBy=propertyLocation">Location</a></strong></u></td>
          <td><u><strong><a href="?sortBy=propertyStatus">Status</a></strong></u></td>
          <td>&nbsp;</td>
        </tr>
        <?php do { ?>
          <tr>
		...
		?>
            ...
            <td><?php echo $row_listings['mlsNumber']; ?></td>
            <td><?php echo $row_listings['propertyLocation']; ?></td>
            <td><?php echo $row_listings['propertyStatus']; ?></td>
            <td>
