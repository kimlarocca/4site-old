...
<div class="twd_container">
  <div class="twd_row">
    <div class="twd_column twd_two twd_margin20">
      ...
      <p><?php echo $row_listing['productName']; ?></p>
      <p><span class="red">Caution: this action cannot be undone!!</span></p>
      <form id="form1" name="form1" method="post" action="products-delete2.php">
        <input type="submit" name="button" id="button" value="Delete Product" />
        <input name="productID" type="hidden" id="productID" value="<?php echo $row_listing['productID']; ?>" />
      </form>
