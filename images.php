...
$coverPhotoID = $_GET['coverPhotoID'];
?>
<?php do { ?>

    <div class="pin"><a
                href="photos-modify.php?albumID=<?php echo $_GET['albumID']; ?>&photoID=<?php echo $row_photos['id']; ?>"><img
        ...
        <div style="margin:auto; width:100px; padding:10px 0 10px 0"><a
                    href="albums-photos.php?action=cover&albumID=<?php echo $_GET['albumID']; ?>&photoID=<?php echo $row_photos['id']; ?>"
            ...
            <a href="photos-modify.php?albumID=<?php echo $_GET['albumID']; ?>&photoID=<?php echo $row_photos['id']; ?>"
               class="tooltip" title="update photo"><img style="width:22px" src="images/edit.png"
                                                         width="32" height="32"/></a> <a
                    href="photos-delete.php?albumID=<?php echo $_GET['albumID']; ?>&photoID=<?php echo $row_photos['id']; ?>"
