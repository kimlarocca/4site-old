...
<div class="twd_container">
  <div class="twd_row">
    <div class="twd_column twd_two twd_margin20">
      <h2>Rentals</h2>
      <p><a href="listings-add.php?church=yes" class="button">add a new rental</a></p>
<h3>manage your rentals</h3>
<?php
//check url parameters
if ($_GET['action'] == 'deleted') print '<p style="color:red;">Your rental has been deleted.</p>';
if ($_GET['action'] == 'added') print '<p style="color:red;">Your rental has been added.</p>';
?>
<table border="0" cellpadding="5" cellspacing="0">
        <tr>
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><u><strong><a href="?sortBy=propertyLocation">Location</a></strong></u></td>
          <td>&nbsp;</td>
        </tr>
        <?php do { ?>
          <tr>
		...
		?>
            ...
            <td><?php echo $row_listings['propertyLocation']; ?></td>
            <td>
                <a class="tooltip" title="edit this rental" href="listings-modify.php?church=yes&listingID=<?php echo $row_listings['listingID']; ?>"><img src="images/edit.png" width="22" height="22" /></a> <a class="tooltip" title="rental photos" href="albums-photos.php?listingID=<?php echo $row_listings['listingID']; ?>&albumID=<?php echo $row_listings['albumID']; ?>"><img src="images/image.png" width="22" height="22" /></a> <a class="tooltip" title="delete this rental" href="church-rental-delete.php?church=yes&listingID=<?php echo $row_listings['listingID']; ?>"><img src="images/delete.png" width="22" height="22" /></a>
            </td>
          </tr>
