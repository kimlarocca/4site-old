...
if ((isset($_GET['websiteID'])) && ($_GET['websiteID'] != "")) {
  $deleteSQL = sprintf("DELETE FROM cmsWebsites WHERE websiteID=%s",
                       GetSQLValueString($_GET['websiteID'], "int"));

  mysqli_select_db($cms, $database_cms);
  $Result1 = mysqli_query($deleteSQL, $cms) or die(mysqli_error($cms));

  $deleteGoTo = "kim.php?action=deleted";
...
<div class="twd_container">
  <div class="twd_row">
    <div class="twd_column twd_two twd_margin20">
      ...
      <h3><a href="products.php" class="button"></a></h3>
