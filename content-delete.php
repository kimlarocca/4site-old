...
<div class="twd_container">
  <div class="twd_row">
    <div class="twd_column twd_two twd_margin20">
      ...
      <h3>delete content page: <?php echo $row_content['pageTitle']; ?></h3>
      <p>Are you sure you want to delete this page? </p>
      <p class="red">Caution: this action cannot be undone!!</p>
      <form id="form1" name="form1" method="post" action="content-delete2.php">
        <input type="submit" name="button" id="button" value="Delete Page" />
        <input name="pageID" type="hidden" id="pageID" value="<?php echo $row_content['pageID']; ?>" />
      </form>
      <p>&nbsp;</p>
    </div>
  </div>
