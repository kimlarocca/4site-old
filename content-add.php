...
$lastContent = mysql_query($query_lastContent, $cms) or die(mysql_error());
$row_lastContent = mysql_fetch_assoc($lastContent);
$totalRows_lastContent = mysql_num_rows($lastContent);
?>
<?php
