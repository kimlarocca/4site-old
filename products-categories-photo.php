...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE productCategories SET file_name=%s WHERE productCategoryID=%s",
  ...
  $updateGoTo = "products-categories.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$category = mysql_query($query_category, $cms) or die(mysql_error());
...
<div class="twd_container">
  <div class="twd_row">
    <div class="twd_column twd_two twd_margin20">
      <h2>Product Catalog Module: Category Photo</h2>
      <h3>&nbsp;
        <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
          <table align="center">
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">File_name:</td>
              <td><input type="text" name="file_name" value="<?php echo htmlentities($row_category['file_name'], ENT_COMPAT, 'UTF-8'); ?>" size="32" /></td>
            </tr>
            <tr valign="baseline">
