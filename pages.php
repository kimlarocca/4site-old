...
mysqli_select_db($database_cms, $cms);
$query_Recordset1 = "SELECT * FROM cmsPages,cmsWebsites WHERE cmsPages.websiteID=cmsWebsites.websiteID ORDER BY ".$sortBy;
  ...
  <div class="twd_row">
    <div class="twd_column twd_two twd_margin20">
      ...
      <table border="0" cellpadding="3" cellspacing="0">
        <tr>
          <td><strong><a href="?sortBy=pageID">ID</a></strong></td>
          <td><strong><a href="?sortBy=pageTitle">Title</a></strong></td>
          <td><strong><a href="?sortBy=url">URL</a></strong></td>
        </tr>
        <?php do { ?>
          <tr>
            <td><?php echo $row_Recordset1['pageID']; ?></td>
            <td><a href="content-modify.php?pageID=<?php echo $row_Recordset1['pageID']; ?>"><?php echo $row_Recordset1['pageTitle']; ?></a></td>
