        ...
        <table border="0" cellpadding="5" cellspacing="0">
          ...
          <?php do { ?>
            <tr>
              ...
              <td><?php echo $row_content['websiteID']; ?></td>
              <td><?php echo $row_content['username']; ?></td>
              <td><?php echo $row_content['pageTitle']; ?></td>
              <td><a href="content-preview.php?pageID=<?php echo $row_content['pageID']; ?>">preview</a></td>
